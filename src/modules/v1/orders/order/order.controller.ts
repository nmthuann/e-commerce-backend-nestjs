import { Controller, Get, Param, Inject, Patch, UseGuards, Request } from '@nestjs/common'
...
export class OrderController {
  ...
  async updateConfirmedOrder(@Request() req: any, @Param('order_id') order_id: number): Promise<OrderEntity> {
  ...
  async updateCanceledOrder(@Request() req: any, @Param('order_id') order_id: number): Promise<OrderEntity> {
  ...
  async updateInProgressOrder(@Param('order_id') order_id: number): Promise<OrderEntity> {
  ...
  async updateCompletedOrder(@Param('order_id') order_id: number): Promise<OrderEntity> {
    return await this.orderService.handleCompletedOrder(order_id)
  }

  @Patch('update-refunded/:order_id')
  async updateRefundedOrder(@Param('order_id') order_id: number): Promise<OrderEntity> {
